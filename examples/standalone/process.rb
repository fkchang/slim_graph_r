...
SlimGraphR.diagram(:process, title: 'Quarterly survey — tools and payloads') do
  ...
  operation :build_app, 'Build app', lane: :it, stage: :build, tool: 'CSPro',
            detail: 'form + validation', input: 'FL', output: 'TB'
